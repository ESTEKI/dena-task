...
راهنمایی: به طور کلی سوالاتی که با چه تعداد یا چند یا چنتا پرسیده میشوند به احتمال بالا در این دسته قرار میگیرند.
...
راهنمایی: سوالاتی که با چه کسی یا کدام یا میانگین پرسیده میشوند به احتمال بالا در این دسته قرار میگیرند.
